...
# Code is running without a hitch. For the next iteration, will add the error dist to flight locations
...
model_compiled <- stan_model(here("bayesian_modeling", "stan", "stan_attempt_5.stan"))
