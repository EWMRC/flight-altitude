...
# something is breaking here: check my assumptions
...
parameters <- c("mu_bias_ground", "mu_bias_add", "mu_bias_flight", 
...
m_test <- jags(data=jags_data, inits=inits, parameters.to.save = parameters, 
               model.file=here("bayesian_modeling", "gamma_drone_model.jags"), n.chains=nc, n.iter=ni, n.burnin=nb,
               parallel=T)
